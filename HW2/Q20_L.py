...
plt.legend()
plt.grid(True)
plt.savefig(os.path.join(output_dir, "Q20_running_time_comparison.png"), dpi=300, bbox_inches='tight')
plt.close()
...
plt.legend()
plt.grid(True)
plt.savefig(os.path.join(output_dir, "Q20_ls_error_comparison.png"), dpi=300, bbox_inches='tight')
plt.close()